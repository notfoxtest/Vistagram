...
export const AuthProvider = ({ children }) => {
  ...
  const [theme, setTheme] = useState(localStorage.getItem('vistagram_theme') || 'liquid-glass');
  ...
  useEffect(() => {
    document.documentElement.setAttribute('data-theme', theme === 'liquid-glass' ? '' : theme);
