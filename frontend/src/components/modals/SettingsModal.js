          ...
          <TabsContent value="profile" className="space-y-4 mt-4">
            ...
            <div className="flex items-center gap-4 p-4 rounded-xl bg-black/30">
              ...
              <div>
                ...
                <Button
                  size="sm"
                  variant="outline"
                  className="mt-2 border-white/10 text-zinc-300 hover:text-white"
                >
                  Change Avatar
                </Button>
              </div>
            ...
            <div className="space-y-2">
              ...
              <Select value={status} onValueChange={setStatus}>
                <SelectTrigger
                  className="bg-black/50 border-white/10 text-white"
                  data-testid="settings-status-select"
                >
                  <SelectValue />
                </SelectTrigger>
                <SelectContent className="bg-black/95 border-white/10">
                  ...
                  <SelectItem value="idle" className="text-yellow-400">
                    🟡 Idle
                  </SelectItem>
                  <SelectItem value="dnd" className="text-red-400">
                    🔴 Do Not Disturb
                  </SelectItem>
                  <SelectItem value="offline" className="text-zinc-400">
                    ⚫ Invisible
                  </SelectItem>
                </SelectContent>
              </Select>
            ...
            <div className="relative p-6 rounded-2xl overflow-hidden">
              ...
              <div className="relative z-10 text-center">
                ...
                <p className="text-white/80 mb-4">
                  Unlock animated avatars, custom profiles, and more!
                </p>
                ...
                <div className="grid grid-cols-2 gap-3 mb-6 text-left">
                  <div className="p-3 bg-white/10 rounded-lg">
                    ...
                    <p className="text-sm text-white/60">
                      Use GIFs as your avatar
                    </p>
                  </div>
                  <div className="p-3 bg-white/10 rounded-lg">
                    <p className="text-white font-medium">Custom Banner</p>
                    <p className="text-sm text-white/60">
                      Stand out with a profile banner
                    </p>
                  </div>
                  <div className="p-3 bg-white/10 rounded-lg">
